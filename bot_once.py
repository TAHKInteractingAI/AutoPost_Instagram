...
def _write_pw_worker():
    ...
    lines = [
        ...
        '\n',
        '        # Scroll ngẫu nhiên để giả lập người thật đang đọc feed\n',
        '        random_scroll(page, times=random.randint(1, 3))\n',
        '\n',
        '        # ── Tự đăng nhập lại nếu session hết hạn ──\n',
        '        if "login" in page.url or "accounts/login" in page.url:\n',
        '            page.screenshot(path="/tmp/debug_login_screen.png")\n',
        '            log("   ⚠️ Session hết hạn — thử đăng nhập lại...")\n',
        ...
        '                time.sleep(random.uniform(3.0, 5.0))\n',
        '                page.screenshot(path="/tmp/debug_after_relogin.png")\n',
        '                log(f"   🔗 URL sau login: {page.url}")\n',
        '                if "login" in page.url:\n',
        '                    log("ERR:RELOGIN_FAILED")\n',
        '                    sys.exit(2)\n',
        '                # Lưu session mới\n',
        '                context.storage_state(path=SESSION_FILE)\n',
        '                log("   ✅ Đăng nhập lại thành công — session mới đã lưu")\n',
        '                dismiss_popups(page)\n',
        '                time.sleep(random.uniform(2.0, 3.0))\n',
        '            except Exception as login_err:\n',
        '                log(f"ERR:RELOGIN_EXCEPTION:{str(login_err)[:100]}")\n',
        '                sys.exit(2)\n',
        '\n',
